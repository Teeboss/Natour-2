...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      set: value => Math.round(value * 10) / 10 // 4.666666, 4.666, 47, 4.7
    },
    ratingsQuantity: {
      type: String,
      default: 0,
...
// DOCUMENT MIDDLEWARE: runs before the .save() and .created() not Update()
...
// });
// tourSchema.pre('save', function (next) {
//   console.log('Will save some document...');
//   next();
// });
