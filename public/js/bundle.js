...
})(
  {
    ...
    'mapbox.js': [
      function (require, module, exports) {
        ...
        //     'pk.eyJ1IjoidGVlYm9zcyIsImEiOiJjbHZueDFtZmkwaWI1Mm1tZ202ODZnbnd5In0.atm2CLBk6K5oe7mH6RXYvQ';
        //   const map = new mapboxgl.Map({
        //     container: 'map',
        //     style: 'mapbox://styles/teeboss/clvnyw1q801lc01qv46jmayej',
        //     scrollZoom: false,
 ...
 */
    ...
    '../../node_modules/axios/lib/adapters/xhr.js': [
      function (require, module, exports) {
        ...
        var _progressEventReducer = _interopRequireDefault(
          require('../helpers/progressEventReducer.js')
        );
            ...
            return new Promise(function dispatchXhrRequest(resolve, reject) {
              ...
              if (typeof _config.onDownloadProgress === 'function') {
                request.addEventListener(
                  'progress',
                  (0, _progressEventReducer.default)(
                    _config.onDownloadProgress,
                    true
                  )
                );
              }
              ...
              if (
                typeof _config.onUploadProgress === 'function' &&
                request.upload
              ) {
                request.upload.addEventListener(
                  'progress',
                  (0, _progressEventReducer.default)(_config.onUploadProgress)
                );
              }
                ...
                if (_request.body) {
                  data = (0, _trackStream.trackStream)(
                    ...
                    fetchProgressDecorator(
                      ...
                      (0, _progressEventReducer.default)(onUploadProgress)
                    ),
                    null,
                    encodeText
                  );
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        // DOM ELEMENTS
        const mabBox = document.getElementById('map');
